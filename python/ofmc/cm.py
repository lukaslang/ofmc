...
A = - fx*fx*v*w*dx - fx*f*v*w.dx(1)*dx - f*fx*v.dx(1)*w*dx - f*f*v.dx(1)*w.dx(1)*dx - alpha*inner(v.dx(1), w.dx(1))*dx - beta*inner(v.dx(0), w.dx(0))*dx
l = ft*fx*w*dx + ft*f*w.dx(1)*dx
