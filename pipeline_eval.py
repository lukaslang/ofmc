...
#
# This script runs the evaluation of all datasets and all models.
import collections
import os
import datetime
import glob
...
if mode is 'DIFFERENT':
    # Paramters for of1d.
    alpha0_of1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha1_of1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    prod_of1d = list(it.product(alpha0_of1d, alpha1_of1d))

    # Paramters for cms1dl2.
    alpha0_cms1dl2 = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha1_cms1dl2 = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    ...
    # Paramters for cms1d.
    alpha0_cms1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha1_cms1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha2_cms1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha3_cms1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    ...
    alpha0_cmscr1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha1_cmscr1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha2_cmscr1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    alpha3_cmscr1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
    beta_cmscr1d = [1e-3, 5e-3, 1e-2, 5e-2, 1e-1]
